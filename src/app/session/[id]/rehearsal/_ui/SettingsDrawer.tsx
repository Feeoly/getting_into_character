      ...
      <aside className="absolute right-0 top-0 h-full w-[min(420px,92vw)] overflow-auto bg-white p-6 shadow-xl">
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-11 items-center justify-center rounded-lg border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-900 outline-none ring-offset-2 transition hover:bg-slate-50 focus-visible:ring-2 focus-visible:ring-blue-600"
          >
            关闭
          </button>
        </div>
        ...
        <div className="mt-6 space-y-6">
          <section className="rounded-lg border border-slate-200 bg-white p-4">
            <div className="text-sm font-semibold text-slate-900">停顿提示</div>
            <div className="mt-3 flex items-center justify-between gap-4">
              <div className="text-sm text-slate-600">提示开关</div>
              <button
                type="button"
                onClick={() =>
            ...
            <div className="mt-4">
              <div className="flex items-baseline justify-between">
                <div className="text-sm text-slate-600">停顿阈值</div>
                <div className="text-sm font-semibold text-slate-900">{thresholdSec}s</div>
              </div>
              <input
                type="range"
                min={1}
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-4">
            <div className="text-sm font-semibold text-slate-900">场景背景</div>
                ...
                <div className="ml-6">
                  ...
                  <div className="mt-3">
                    <input
                      ...
                      className="block w-full text-sm text-slate-900 file:mr-3 file:rounded-lg file:border file:border-slate-200 file:bg-white file:px-4 file:py-2 file:text-sm file:font-semibold file:text-slate-900 hover:file:bg-slate-50"
                    />
                    {uploadBusy ? (
                      <div className="mt-2 text-sm text-slate-600">正在保存…</div>
                    ) : null}
                  </div>
                </div>
              ) : null}
