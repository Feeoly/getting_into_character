...
export const metadata: Metadata = {
  title: "预测题 · 入戏",
  description: "河北省公务员面试趋势与模拟题（本地文档）",
};

export default function PredictExamsPage() {
  const items = loadGongwuyuanDocs("predict_exams");
    ...
    <main className="px-6 py-8 md:px-12 md:py-12">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-3 max-w-2xl text-[15px] leading-[1.65] text-ink-muted">
          文档来自 <code className="rounded bg-ink/5 px-1.5 py-0.5 font-mono text-[0.9em]">gongwuyuan/predict_exams</code>，Tab 切换不同篇目。
        </p>
