...
**Domain:** 浏览器端面试排练（录屏/摄像头/字幕/本地优先隐私）
...
# Supporting
npm install @sqlite.org/sqlite-wasm@3.51.2-build8 zustand zod
npm install tailwindcss@4.2.2

# Optional: heavy video processing (use sparingly)
npm install @ffmpeg/ffmpeg@12.15 @ffmpeg/util

# Dev dependencies
npm install -D vitest@4.1.4 typescript
```
...
---
*Stack research for: 浏览器端面试排练（本地优先隐私、录屏、中文转写）*
*Researched: 2026-04-09*
